...
def build_geodataframe(gbif_path = "/data/cher/universe7/herbarium/data/MO-herbarium/occurrence.txt"):
    ...
    habitat_info = habitat_info[['occurrenceID', 'species' ,'habitat' , 'stateProvince', 'decimalLatitude', 'decimalLongitude']]

    data = habitat_info[~habitat_info['habitat'].isna()].copy()

    # Convert to GeoDataFrame
    data = _clean_data(data[['occurrenceID', 'species' ,'habitat', 'stateProvince','decimalLatitude', 'decimalLongitude']].copy())
